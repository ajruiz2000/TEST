...
#include "ini.h"
	...
	/** I/O pin definitions for Athena, NesLab and High Temp************/
	#define mInitBits()			TRISC = 0b0000; ODCC = 0b0000; LATC = 0b0000;

	#define AthenaBit			LATCbits.LATC2 //
	#define ChillerBit			LATCbits.LATC1 //
	#define HighTempBit			LATCbits.LATC3 //

	#define AthenaOff()         AthenaBit = 0; 
	#define NesLabOff()         ChillerBit = 0;
	#define JulaboOff()			ChillerBit = 0;
	#define HighTempOff()       HighTempBit = 0;  

	#define AthenaOn()         AthenaBit = 1; 
	#define NesLabOn()         ChillerBit = 1;
	#define JulaboOn()         ChillerBit = 1;
	#define HighTempOn()       HighTempBit = 1;  

	/** I/O pin definitions for FAN************/
        #if defined(ThermalStage2_5)
            #define mInitFanBits()	   TRISBbits.TRISB0=1; TRISBbits.TRISB2=1; TRISBbits.TRISB1=0; LATBbits.LATB1=1; CNPUE = 0xFF;
            #define FanSensor1             PORTBbits.RB0
            #define FanBit                 LATBbits.LATB1
            #define FanOn()                FanBit = 0;
            #define FanOff()               FanBit = 1;
         #else
            #define mInitFanBits()	   TRISBbits.TRISB0=1; TRISBbits.TRISB2=1; TRISBbits.TRISB1=0; LATBbits.LATB1=0; CNPUE = 0xFF;
            #define FanSensor1             PORTBbits.RB0
            #define FanBit                 LATBbits.LATB1
            #define FanOn()                FanBit = 1;
            #define FanOff()               FanBit = 0;
        #endif
#endif
