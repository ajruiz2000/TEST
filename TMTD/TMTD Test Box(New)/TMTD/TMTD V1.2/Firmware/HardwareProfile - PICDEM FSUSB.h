...
#define HARDWARE_PROFILE_PICDEM_FSUSB_H
   ...
   // #define tris_self_power     TRISAbits.TRISA2    // Input
    ...
    /** LED ************************************************************/
    #define mInitAllLEDs()      LATD &= 0x00; TRISD &= 0x00; LATE &= 0x00; TRISE &= 0x00;LATC &= 0x00; TRISC &= 0x00;
    
    #define mLED_1              LATDbits.LATD0
    #define mLED_2              LATDbits.LATD1
    #define RS		            LATDbits.LATD2
    #define	Enable		        LATDbits.LATD3
	...
	#define Control_BIT				    LATCbits.LATC0
 ...
 //   #define mGetLED_3()         mLED_3
  //  #define mGetLED_4()         mLED_4
	...
	#define Control_BIT_On()         	Control_BIT = 1;
   
    
    #define mLED_1_Off()        mLED_1 = 0;
    #define mLED_2_Off()        mLED_2 = 0;
	#define mLED_3_Off()        mLED_3 = 0;
	#define Control_BIT_Off()         	Control_BIT = 0;

    
    #define mLED_1_Toggle()     mLED_1 = !mLED_1;
    #define mLED_2_Toggle()     mLED_2 = !mLED_2;
	#define mLED_3_Toggle()     mLED_3 = !mLED_3;
	#define Control_BIT_Toggle()        Control_BIT = !Control_BIT;
   
    
    /** SWITCH *********************************************************/
    #define mInitAllSwitches()  TRISBbits.TRISB0=1;TRISBbits.TRISB1=1;
    #define DC_Switch           PORTBbits.RB0
    #define MG_Switch           PORTBbits.RB1
	#define LCD_Display			PORTBbits.RB2
	#define MovieGateState	    PORTBbits.RB5
